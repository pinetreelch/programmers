...
def solution(schedules, timelogs, startday):
    ...
    # 딕셔너리 변환
    # zip() 함수는 여러 개의 iterable(리스트, 튜플 등)을 묶어서 하나의 튜플로 된 iterator를 생성하는 함수야.
    # 즉, 각 iterable에서 동일한 인덱스에 있는 요소들을 묶어서 새로운 쌍을 만들 때 사용돼.
    ...
    for key, values in attendance_dict.items():
